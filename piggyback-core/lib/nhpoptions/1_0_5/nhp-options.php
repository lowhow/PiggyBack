...
$sections[] = array(
		...
		'title' => __('Site Settings', 'nhp-opts'),
		'desc' => __('<p class="description">General Settings on site</p>', 'nhp-opts'),
		'fields' => array(
        array(
          'id' => 'responsive',
          'type' => 'checkbox',
          'title' => __('Responsive Layout', 'nhp-opts'), 
          'sub_desc' => __('Adds meta tag with viewport attribute', 'nhp-opts'),
          'desc' => __('Check to enable', 'nhp-opts'),
          'std' => '0'// 1 = on | 0 = off
        ),
        array(
          'id' => 'maintenance_mode',
          'type' => 'checkbox',
          'title' => __('Maintenance Mode', 'nhp-opts'), 
          'sub_desc' => __('Sets site to Maintenance. Only super admin gets to view', 'nhp-opts'),
          'desc' => __('Check to enable', 'nhp-opts'),
          'std' => '0'// 1 = on | 0 = off
        ),
				array(
					...
					'desc' => __('This is the footer text field, put your copyright here.', 'nhp-opts'),
				...
				array(
					...
					'sub_desc' => __('HTML Allowed (wp_kses)', 'nhp-opts'),
					'desc' => __('GA should come with script tag. If available, this code will be place before head closes.', 'nhp-opts'),
					'validate' => 'html', //see http://codex.wordpress.org/Function_Reference/wp_kses_post
					'std' => 'HTML is allowed in here.'
				)
